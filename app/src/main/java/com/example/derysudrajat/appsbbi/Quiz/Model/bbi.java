...
public class bbi extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.derysudrajat.appsbbi.Quiz.Model/databases/";
    ...
    public bbi(Context context) {//constructor

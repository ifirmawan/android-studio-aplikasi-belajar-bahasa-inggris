...
public class Auth {
    ...
    private final String BASE_URL = "http://bbi.quality-assurance-bri.com";
    ...
    public void submitHighscore(){
        ...
        StringRequest s = new StringRequest(Request.Method.POST, URL_HIGHSCORE, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("SUBMITHIGHSCORE",response);
                User user = new User();
                user.setUserID(1);
                user.setHighscore(9);
            }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.e("SUBMITHIGHSCORE",error.getMessage());
                errorMessage = error.getMessage();
            ...
            protected Map<String, String> getParams()
            {
                ...
                params.put("highscore",String.valueOf(user.getHighscore()));
                return params;
            }
        };
        MySingleton.getInstance(context).addToRequestQueue(s);

...
import com.example.derysudrajat.appsbbi.Quiz.ScoreAdapter;
    ...
    public void LoadHighScoreFromServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(RiwayatScoreFragment3.this,"Loading score","Please Wait",false,false);
            }

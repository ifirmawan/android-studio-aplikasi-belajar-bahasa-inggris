...
public class quissimple3 extends AppCompatActivity {
 public MediaPlayer mpa, mpb, mpc;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quissimple3);
    }
    public void playJawaban1(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.imgVi6:
                ...
                mpa = MediaPlayer.create(this, R.raw.soa1);
                break;
    ...
    public void playJawaban3(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.imgVi66a:
                //Log.i("Test", "Cow Button");
                mpc = MediaPlayer.create(this, R.raw.soa3);
                break;
